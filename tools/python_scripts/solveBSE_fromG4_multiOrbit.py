...
class BSE:
    ...
    def readData(self):
        ...
        self.vertex_channel = a.decode("utf-8") 
        ...
        self.U = array(f['parameters']['TwoBandCu-model']['U'])[0]
        print("U = ",self.U)

        self.t00    = array(f['parameters']['TwoBandCu-model']['t00'])[0]
        self.tp00   = array(f['parameters']['TwoBandCu-model']['tp00'])[0]
        self.tpp00  = array(f['parameters']['TwoBandCu-model']['tpp00'])[0]
        self.t11    = array(f['parameters']['TwoBandCu-model']['t11'])[0]
        self.tp11   = array(f['parameters']['TwoBandCu-model']['tp11'])[0]
        self.tpp11  = array(f['parameters']['TwoBandCu-model']['tpp11'])[0]
        self.t01    = array(f['parameters']['TwoBandCu-model']['t01'])[0]
        # self.tp01   = array(f['parameters']['TwoBandCu-model']['tp01'])[0]
        self.tpp01  = array(f['parameters']['TwoBandCu-model']['tpp01'])[0]
        self.DeltaE = array(f['parameters']['TwoBandCu-model']['delta-E'])[0]
        ...
        # G4(w1,k1,w2,k2,l1,l2,l3,l4)
        self.G4  = array(f['functions/G4_PARTICLE_PARTICLE_UP_DOWN'])[0,0,:,:,:,:,:,:,:,:]
        ...
        # sigma(w,k,l1,l2)
        self.sigma  = array(f['functions/Self_Energy'])[:,:,0,:,0,:]
                                    ...
                                    for l2 in range(self.nOrb):
                                        for l3 in range(self.nOrb):
                                            for l4 in range(self.nOrb):
                                                ...
                                                self.G4[iw1,k1,iw2,ik2,l1,l2,l3,l4] -= 2.0 * self.Green[iw1Green,ik1,l1,l2] * self.Green[iw2Green,ik2,l4,l3]
